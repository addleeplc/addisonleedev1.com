...
$heading         = get_field( 'heading', $blog_page_id );
$text            = get_field( 'text', $blog_page_id );
...
<div class="hero-simple mk-px-4 mk-pt-12 mk-pb-8 md:mk-py-32 mk-bg-black" id="hero-simple">
	<div class="mk-max-w-site mk-mx-auto">
		<h1 class="mk-text-1md-title md:mk-text-2xl-title mk-font-medium mk-text-white mk-uppercase"><?php echo esc_html( $heading ); ?></h1>
		<?php if ( $text ) { ?>
			<div class="mk-max-w-lg">
				<p class="mk-text-lg mk-text-white/64 mk-mt-6"><?php echo wp_kses_post( $text ); ?></p>
			</div>
		<?php } ?>
	</div>
</div>
<div class="mk-bg-white md:mk-pt-6 mk-pb-8 md:mk-pb-28">
	...
	<div class="mk-px-4">
		...
		<div class="post-listings-grid mk-max-w-site mk-mx-auto mk-grid mk-grid-cols-1 md:mk-grid-cols-2 lg:mk-grid-cols-3 mk-gap-x-4 mk-gap-y-8 md:mk-gap-y-12" data-post-type="post">
