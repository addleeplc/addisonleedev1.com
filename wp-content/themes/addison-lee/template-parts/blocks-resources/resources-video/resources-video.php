...
// Block ID.
$block_id = 'resources-video';
if ( ! empty( $block['anchor'] ) ) {
	$block_id = $block['anchor'];
}

// Additional classes.
$class_name = 'resources-video';
if ( ! empty( $block['className'] ) ) {
	$class_name .= ' ' . $block['className'];
} ?>

<div class="mk-py-7 md:mk-py-10 <?php echo esc_html( $class_name ); ?>" id="<?php echo esc_html( $block_id ); ?>">
	<?php if ($video_type == 'file') { ?>
		<div class="text-video-white-card mk-relative video-field-container">
			<video class="video-field mk-w-full mk-h-image-blog mk-object-cover mk-my-0" poster="<?php echo $video_still['url'] ? esc_html( $video_still['url'] ) : ''; ?>">
