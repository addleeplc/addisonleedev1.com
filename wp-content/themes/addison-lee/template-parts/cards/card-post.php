...
<div class="blog-card mk-flex mk-flex-col">
	<a class="mk-relative mk-block mk-h-image-sm" href="<?php echo esc_html( $cta ); ?>">
	...
	<div class="mk-h-auto mk-grow mk-flex mk-flex-col mk-justify-between mk-p-6 mk-border mk-border-black/15 mk-border-t-0">
		<div>
			...
			<p class="mk-text-lg mk-text-black/64 mk-leading-tight mk-line-clamp-2 mk-mt-3 mk-mb-7"><?php echo esc_html( $excerpt ); ?></p>
		</div>
		<div>
