...
$blog_highlights = get_field( 'blog_highlights', 'options' );
...
<div class="blog-highlights-carousel lg:mk-col-span-3 mk-w-full lg:mk-flex mk-items-stretch md:mk-flex-row-reverse">
		...
		<div class="image-carousel">
			<div class="glide__track mk-h-full" data-glide-el="track">
				<ul class="glide__slides mk-h-full">
					<?php
					foreach ( $blog_highlights as $slide ) {
						$image = get_the_post_thumbnail_url( $slide->ID );
						?>
						<li class="glide__slide">
							<img class="mk-w-full mk-h-image-1sm sm:mk-h-image-sm lg:mk-h-536 mk-object-cover" src="<?php echo esc_html( $image ); ?>" alt="">
						</li>
					<?php } ?>
				</ul>
			</div>
	...
	<div class="lg:mk-w-1/2 mk-bg-third-grey mk-px-4 mk-overflow-hidden">
		<div class="mk-h-full md:mk-max-w-[392px] mk-mx-auto mk-py-8 mk-flex mk-items-center">
			<div class="text-carousel fade-slider md:mk-flex mk-flex-col mk-justify-center">
				<div class="glide__track" data-glide-el="track">
					<ul class="glide__slides">
						...
						foreach ( $blog_highlights as $slide ) {
							...
							?>
							<li class="glide__slide">
								<div class="text-carousel-content mk-min-h-[180px] mk-h-full sm:mk-flex mk-flex-col md:mk-justify-end">
									<?php if ( $categories ) { ?>
										<div class="mk-text-lg mk-hidden md:mk-flex mk-items-center mk-gap-2 mk-mt-1 mk-text-xxxxxs-title mk-text-black/64 mk-mb-4">
									...
									<?php } ?>
									<h2 class="mk-text-xl sm:mk-text-1sm-title mk-font-medium mk-uppercase mk-mb-4"><?php echo esc_html( $post_title ); ?></h2>
									<p class="mk-text-lg mk-text-black/64 mk-leading-tight mk-hidden sm:mk-block"><?php echo esc_html( $excerpt ); ?></p>
									<?php if ( $cta ) { ?>
										<div class="mk-mt-4 sm:mk-mt-9">
				...
				<div class="mk-hidden md:mk-flex mk-justify-between mk-items-center mk-mt-8">
					<div class="slider-controls mk-flex mk-gap-2" data-glide-el="controls" data-glide-length="<?= count( $blog_highlights ); ?>">
	...
	<div class="mk-flex md:mk-hidden mk-justify-between mk-items-center mk-mt-4">
		<div class="mk-text-lg mk-font-medium ">
			...
			<span>/<?php echo count( $blog_highlights ); ?></span>
		</div>
